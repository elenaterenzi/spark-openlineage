...
namespace Function.Domain.Services
{
    ...
    public class OlToPurviewParsingService : IOlToPurviewParsingService
    {
        ...
        public string? GetPurviewFromOlEvent(EnrichedEvent eventData)
        {
            ...
            var sparkAppParser = new SparkAppParser(_logger);
            var sparkApp = sparkAppParser.GetSparkApplication(eventData.OlEvent);
            var sparkProcessParser = new SparkProcessParser(_config, 
