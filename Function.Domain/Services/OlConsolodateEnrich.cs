            ...
            try{
                ...
                if (_event.EventType == START_EVENT_TYPE)
                {
                    ...
                    // {
                        ...
                        var envParent = new EnvironmentPropsParent();
                        if (!await olMessageConsolodation.CaptureEnvironmentFromStart(_event, _event.Run.RunId, envParent))
                        {
                ...
                else if (_event.EventType == COMPLETE_EVENT_TYPE)
                {
                    ...
                    {
                        var enrichedEvent = olEnrichMessage.GetEnrichedEvent(consolodatedEvent);
